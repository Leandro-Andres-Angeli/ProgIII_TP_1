...
const getNedStarkInfo = async () => {
  console.info(
    formatMessage('recuperando la información del personaje “Ned Stark”')
  );
  await fetchApi('https://thronesapi.com/api/v2/Characters/6');
};
module.exports = getNedStarkInfo;
