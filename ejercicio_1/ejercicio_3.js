...
const main = async () => {
    console.info(formatMessage('Recuperando la información de todos los personajes disponibles'));
    
    try {
        //2)Realizar una función que permita recuperar todos los personajes disponibles.
        const characters = await fetchApi('https://thronesapi.com/api/v2/Characters');
